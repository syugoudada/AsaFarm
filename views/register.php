      ...
      <div class="card" id="card">
        ...
        <div class="card-body">
          <form action="../action/ItemAction.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group form-group">
              <input type="number" id="item_stock" name="item_stock" class="form-control">
            </div>
            ...
            <div class="d-flex justify-content-between mt-3">
              <div class="custom-control custom-radio mr-2">
                <input type="radio" id="seasonRadio1" name="seasonRadio" class="custom-control-input" value="1">
            ...
            <div class="input-group mb-3">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="inputGroupFile01" name="item_image" aria-describedby="inputGroupFileAddon01">
